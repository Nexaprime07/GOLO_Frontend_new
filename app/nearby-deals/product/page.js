    ...
    const loadProductData = async () => {
      ...
      try {
        ...
        if (!productData) {
          ...
          const rawName = urlParams.productName || "";
          const rawPrice = urlParams.price || "0";
          const rawOriginalPrice = urlParams.originalPrice || "0";
          const rawImage = urlParams.imageUrl || "";
          const rawCategory = urlParams.category || "Product";
          const rawDescription = urlParams.description || "Premium quality product with excellent features and benefits.";
          ...
          productData = {
            ...
            stockQuantity: Number(urlParams.stockQuantity) || 0,
